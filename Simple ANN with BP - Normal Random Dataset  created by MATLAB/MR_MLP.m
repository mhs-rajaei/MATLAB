...
Load_Data;
    ...
    test_set = test_set';%test_set(1:number_of_input_neurons,1:number_of_test_samples);


%% input dialog
prompt = {'Learning rate:','alfa:(Momentum coefficient)','lambda:(Regularization coefficient)'};
dlg_title = 'Input';
num_lines = 1;
defaultans = {'0.2','0','0'};
...
% learning_rate:
parameter.learning_rate =str2num(answer{1});
% momentum value:
parameter.alfa =str2num(answer{2});
% regularization:
parameter.lambda =str2num(answer{3});
...
clear('training_set','answer','defaultans','c','dlg_title','num_lines','one_or_multiple',...
